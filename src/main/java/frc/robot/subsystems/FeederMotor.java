...
public class FeederMotor extends SubsystemBase{
    ...
    public FeederMotor() {
        ...
        FeederMotor = new TalonFX(11, "DriveCan");
        ...
        slot0.kV = 0.17192; // A velocity target of 1 rps results in 0.12 V output
        slot0.kA = 0.014074; // An acceleration of 1 rps/s requires 0.01 V output
        ...
        for (int i = 0; i < 5; ++i) {
            status = FeederMotor.getConfigurator().apply(TalonFXConfig);
    ...
    public void periodic() {
                if (m_printCount++ > 10) {
            m_printCount = 0;
            SmartDashboard.putNumber("Velocity", FeederMotor.getVelocity().getValueAsDouble());
          }
