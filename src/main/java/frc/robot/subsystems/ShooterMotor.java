...
public class ShooterMotor extends SubsystemBase{
    ...
    public void setShooterSpeed(double velSetpoint, double accSetpoint){
        ...
        // ShooterMotor.setControl(m_vdFOCReq.withVelocity(velSetpoint).withSlot(0).withAcceleration(accSetpoint).withSlot(0));
      }

    public void ShooterMotorRun(double setpoint){
    ...
    public boolean ShooterAtSetpoint(double setpoint, double tolerance){
        return Math.abs(getShooterMotorSpeed() - setpoint) <= tolerance;
    }
